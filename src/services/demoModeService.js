      ...
      branches: [
        {
          ...
          bps_summary: {
            ...
            positive_records: 10,
            negative_records: 5,
            total_points_awarded: 28,
            total_points_deducted: -12,
          },
          discipline_items: [
            // Positive Reinforcement System (PRS) items
            {
              discipline_item_id: 'prs_1',
              item_title: 'Excellent Homework Submission',
              item_point: 3,
              item_type: 'prs',
            },
            {
              discipline_item_id: 'prs_2',
              item_title: 'Active Class Participation',
              item_point: 2,
              item_type: 'prs',
            },
            {
              discipline_item_id: 'prs_3',
              item_title: 'Leadership in Group Project',
              item_point: 3,
              item_type: 'prs',
            },
            {
              discipline_item_id: 'prs_4',
              item_title: 'Outstanding Science Fair Project',
              item_point: 5,
              item_type: 'prs',
            },
            {
              discipline_item_id: 'prs_5',
              item_title: 'Helping Classmates',
              item_point: 2,
              item_type: 'prs',
            },
            {
              discipline_item_id: 'prs_6',
              item_title: 'Perfect Attendance Week',
              item_point: 2,
              item_type: 'prs',
            },
            {
              discipline_item_id: 'prs_7',
              item_title: 'Excellent Test Score',
              item_point: 3,
              item_type: 'prs',
            },
            {
              discipline_item_id: 'prs_8',
              item_title: 'Improved Behavior',
              item_point: 2,
              item_type: 'prs',
            },
            // Discipline Point System (DPS) items
            {
              discipline_item_id: 'dps_1',
              item_title: 'Disruptive Behavior',
              item_point: -2,
              item_type: 'dps',
            },
            {
              discipline_item_id: 'dps_2',
              item_title: 'Late Assignment',
              item_point: -1,
              item_type: 'dps',
            },
            {
              discipline_item_id: 'dps_3',
              item_title: 'Missing Assignment',
              item_point: -2,
              item_type: 'dps',
            },
            {
              discipline_item_id: 'dps_4',
              item_title: 'Inappropriate Behavior',
              item_point: -3,
              item_type: 'dps',
            },
            {
              discipline_item_id: 'dps_5',
        ...
        },
        {
          ...
          discipline_items: [
            ...
            {
              discipline_item_id: 'dps_2',
              item_title: 'Incomplete Homework',
              item_point: -2,
              item_type: 'dps',
            },
          ],
          bps_records: [
            ...
            },
            {
              ...
              note: 'Arrived 10 minutes late to English class',
              classroom_name: 'Grade 9C',
            },
            {
              id: 14,
              discipline_record_id: 14,
              student_id: 17,
              ...
              item_point: 4,
              date: '2024-01-11',
              teacher_name: 'Art Teacher',
              note: 'Outstanding creativity in art project',
              classroom_name: 'Grade 9C',
            },
            {
              id: 15,
              discipline_record_id: 15,
              student_id: 18,
              student_name: 'Benjamin Taylor',
              item_title: 'Good Behavior',
              item_type: 'prs',
              item_point: 2,
              date: '2024-01-10',
              teacher_name: 'Homeroom Teacher',
              note: 'Consistently respectful and helpful',
              classroom_name: 'Grade 9C',
            },
          ],
          classes: [
...
// Demo student grades data - Enhanced Version 2.0
    ...
    summative: [
      {
        ...
        comment: 'Excellent understanding of algebraic concepts',
        teacher_name: 'Sarah Johnson',
        is_graded: 1,
      ...
      },
      {
        ...
        type_percentage: 25,
        raw_score: 43.5,
        calculated_grade: 87.0,
        letter_grade: 'B+',
        max_score: 50,
        score_percentage: 87.0,
        comment: 'Good grasp of geometric principles',
        teacher_name: 'Sarah Johnson',
        is_graded: 1,
        display_score: '87.0 (B+)',
      ...
      },
      {
        ...
        type_title: 'Major Test',
        type_percentage: 70,
        raw_score: 89,
        calculated_grade: 89.0,
        letter_grade: 'A-',
        max_score: 100,
        score_percentage: 89.0,
        comment: 'Strong understanding of physics concepts',
        teacher_name: 'Dr. Wilson',
        is_graded: 1,
        display_score: '89.0 (A-)',

        template_info: {
          template_id: 3,
          template_name: 'Science Assessment Template',
          assessment_types: [
            {
              type_id: 1,
              title: 'Major Test',
              percentage: 70,
              description: 'Primary assessment',
            },
            {
              type_id: 2,
              title: 'Lab Work',
              percentage: 20,
              description: 'Laboratory assignments',
            },
            {
              type_id: 3,
              title: 'Participation',
      ...
      },
      {
        ...
        type_percentage: 20,
        raw_score: 47.5,
        calculated_grade: 95.0,
        letter_grade: 'A*',
        max_score: 50,
        score_percentage: 95.0,
        comment: 'Outstanding lab work and analysis',
        teacher_name: 'Dr. Wilson',
        is_graded: 1,
        display_score: '95.0 (A*)',
      ...
      },
      {
        ...
        type_percentage: 50,
        raw_score: 85,
        calculated_grade: 85.0,
        letter_grade: 'B+',
        max_score: 100,
        score_percentage: 85.0,
        comment: 'Good analytical skills, needs more depth',
        teacher_name: 'John Smith',
        is_graded: 1,
        display_score: '85.0 (B+)',
